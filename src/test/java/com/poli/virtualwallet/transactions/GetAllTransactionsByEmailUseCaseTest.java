...
import com.poli.virtualwallet.usecase.transactions.GetAllTransactionsByEmailUseCase;
...
@SpringBootTest
public class GetAllTransactionsByEmailUseCaseTest {

    private GetAllTransactionsByEmailUseCase useCase;
    @Autowired
    ...
    @BeforeEach
    public void setUp() {
        useCase = new GetAllTransactionsByEmailUseCase(repository, mapper);
    }

    @Test
    public void getAllTransactionsByEmail() {
        ...
        transaction2.setSource("collaborator1");
